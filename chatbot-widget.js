...
function startConversation() {
    fetch('https://chatbot-for-coast-2-coast-camps.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-coast-2-coast-camps.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzrrhfL-eAFhkB-BBFZG8a6bHJEtrRvkWXrSjyXSpP9aASXBoXjA9tKXs5_0TD1sl-s/exec';
